  ...
  return (
    ...
    >
      <div className="flex flex-col ">
        <div className="w-full h-40 px-60 bg-white relative flex justify-around items-center">
          <h4 className="font-Oswald text-[8.5rem] text-[#677896] font-black">
            02.
          </h4>
          <span className="text-[2rem] font-black text-[#414f6b] absolute left-[24.5rem] top-20">
            CLIMB
          </span>
          <p className="text-justify ml-24 mt-4">
